...
public class Appointment {
	...
	//private Customer customer;	// οι παραπάνω ιδιότητες χρησιμοποιήθηκαν στο class diagram για την διαμόρφωση μιας κλάσης ραντεβού στην οποία θα εμφάνιζε περισσότερες λεπτομέρειες με την χρήση gui
